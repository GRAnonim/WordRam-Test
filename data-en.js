/**
 * WordRam - English Language Data Module (v51)
 * Oxford 3000 / Cambridge CEFR A1-C1 vocabulary, definitions, themes, and placement quiz.
 */
...
const WordRamDataEN = {
  ...
  "GRASS": {
    "tr": "Grass",
    "def": "Слово темы Природа и погода.",
    "ph": "",
    "ex": "",
    "collocations": []
  },
  ...
  "GAS": {
    "tr": "Gas",
    "def": "Слово темы Город и транспорт.",
    "ph": "",
    "ex": "",
    "collocations": []
  },
  ...
  "COP": {
    "tr": "Cop",
    "def": "Слово темы Профессии и общество.",
    "ph": "",
    "ex": "",
    "collocations": []
  },
  ...
  "GYM": {
    "tr": "Gym",
    "def": "Слово темы Спорт и здоровье.",
    "ph": "",
    "ex": "",
    "collocations": []
  },
  ...
  "JOY": {
    "tr": "Joy",
    "def": "Слово темы Разум и чувства.",
    "ph": "",
    "ex": "",
    "collocations": []
  },
  ...
  "BAND": {
    "tr": "Band",
    "def": "Слово темы Искусство и культура.",
    "ph": "",
    "ex": "",
    "collocations": []
  },
  ...
  masteryRanks: [
    ...
    { threshold: 150, title: "Студент", desc: "Базовый словарный запас" },
    { threshold: 200, title: "Исследователь", desc: "Уверенный прогресс" },
    { threshold: 250, title: "Путешественник", desc: "Словарь для диалогов" },
    { threshold: 300, title: "Практик A1", desc: "Полное освоение базового уровня" },
    { threshold: 350, title: "Знаток тем", desc: "Уверенное чтение" },
    { threshold: 400, title: "Полиглот в пути", desc: "Богатый словарный запас" },
    { threshold: 450, title: "Собеседник", desc: "Свободная разговорная речь" },
    { threshold: 500, title: "Уверенный читатель", desc: "Понимание сложных текстов" },
    { threshold: 600, title: "Мастер A2", desc: "Полное владение уровнем A2" },
    { threshold: 700, title: "Эрудит диалогов", desc: "Широкий кругозор" },
    { threshold: 800, title: "Свободный слушатель", desc: "Восприятие беглой речи" },
    { threshold: 900, title: "Мастер B1", desc: "Продвинутое владение языком" },
    { threshold: 1000, title: "Аналитик текстов", desc: "Глубокое понимание нюансов" },
    { threshold: 1100, title: "Виртуоз контекста", desc: "Свободное владение стилями" },
  ...
  evaluatePlacementTest(answers) {
    ...
    const rankInfo = (typeof WordRamData !== "undefined" && WordRamData.xpRanks)
      ? WordRamData.xpRanks.find(r => r.code === assignedLevel)
      : null;

    return {
      code: assignedLevel,
      badge: rankInfo ? rankInfo.badge : assignedLevel,
      title: rankInfo ? rankInfo.title : assignedLevel,
      desc: rankInfo ? rankInfo.desc : "",
      startingXp: rankInfo ? rankInfo.minXp : 0
    };
  }
};

if (typeof window !== "undefined") {
  window.WordRamDataEN = WordRamDataEN;
}
if (typeof globalThis !== "undefined") {
  globalThis.WordRamDataEN = WordRamDataEN;
}
if (typeof module !== "undefined" && module.exports) {
  module.exports = WordRamDataEN;
}
